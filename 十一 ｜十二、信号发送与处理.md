...
>
> - 信号是一种类型的 $\color{red}{进程间通信方式}$ ( **$\color{SkyBl}{一个进程向另一个进程发送信号}$** )
...
>[屏蔽 & 阻塞 , 相关实验参考代码](代码参考链接：https://github.com/WONGZEONJYU/Linux_System_Program/blob/main/10.Signal/12/1_exp/mask_block/main.cpp)
>
