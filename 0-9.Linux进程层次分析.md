...
><img src="photo/image-20230801140504099.png" alt="image-20230801140504099" />

### 3. 编程实验 : Linux进程组

>[pgid_j.cpp参考代码](https://github.com/WONGZEONJYU/Linux_System_Program/blob/main/8.Process_Hierarchy/pgid_j.cpp)
>
><img src="photo/image-20230801140509943.png" alt="image-20230801140509943" />
>
><img src="photo/image-20230801140515601.png" alt="image-20230801140515601" />
...
><img src="photo/image-20230801140523637.png" alt="image-20230801140523637" />
>
>```C+
>setpgrp() <===> setpgid(0,0)
>```
...
>
><img src="photo/image-20230801140530016.png" alt="image-20230801140530016" />
>
><img src="photo/image-20230801140547987.png" alt="image-20230801140547987" />
...
><h2>1.未加休眠</h2>
>
><img src="photo/image-20230801140559705.png" alt="image-20230801140559705" />
>
><img src="photo/image-20230801140605357.png" alt="image-20230801140605357" />
>
><h2>2.加休眠</h2>
>
><img src="photo/image-20230801140613452.png" alt="image-20230801140613452" />
>
>```tex
>注释:代码中的sleep(1),使得子进程先调用了evec(),父进程无法再通过setpgid()改变子进程的组标识(PGID)
>```
>
><img src="photo/image-20230801140630093.png" alt="image-20230801140630093" />
...
>
><img src="photo/image-20230801140646697.png" alt="image-20230801140646697" />

### 3. 登陆实验

#### (1) 准备

><img src="photo/image-20230801140652727.png" alt="image-20230801140652727" />
>
>```tex
...
><img src="photo/image-20230801140700939.png" alt="image-20230801140700939" />

#### (3) 同时按住 ctrl+alt+F2 回到shell图形界面:

><img src="photo/image-20230801140707874.png" alt="image-20230801140707874" />

#### (4) 切换到6号终端,只输入用户名,不登录:

><img src="photo/image-20230801140713877.png" alt="image-20230801140713877" />

#### (5) 切回图形化界面 :

><img src="photo/image-20230801140718841.png" alt="image-20230801140718841" />

#### (6) 切换到6号终端,输入密码登录:

><img src="photo/image-20230801140727204.png" alt="image-20230801140727204" />
...
>```
>
><img src="photo/image-20230801140732292.png" alt="image-20230801140732292" />

### 4. 会话与前后台进程组

><img src="photo/image-20230801140737781.png" alt="image-20230801140737781" />
...
>[pgid_j.cpp参考代码](https://github.com/WONGZEONJYU/Linux_System_Program/blob/main/8.Process_Hierarchy/pgid_j.cpp)
>
><img src="photo/image-20230801140746238.png" alt="image-20230801140746238" />
>
><h2>1. 不带 & 的情况</h2>
>
><img src="photo/image-20230801140752859.png" alt="image-20230801140752859" />
>
><h2>2. 带 & 的情况</h2>
>
><img src="photo/image-20230801140801921.png" alt="image-20230801140801921" />
>
>```
>注释:下图和上图的第二个终端图是重新打开的一个终端
>```
>
><img src="photo/image-20230801140808777.png" alt="image-20230801140808777" />
...
>❓下面的程序输出什么?为什么?
>
><img src="photo/image-20230801140816247.png" alt="image-20230801140816247" />
>
>[session.cpp参考代码](https://github.com/WONGZEONJYU/Linux_System_Program/blob/main/8.Process_Hierarchy/session.cpp)
>
><h2>(1) 实验一</h2>
>
><img src="photo/image-20230801140831249.png" alt="image-20230801140831249" />
>
><img src="photo/image-20230801140847002.png" alt="image-20230801140847002" />
>
><img src="photo/image-20230801140859552.png" alt="image-20230801140859552" />
>
><h2>(2) 实验二</h2>
>
><img src="photo/image-20230801140909503.png" alt="image-20230801140909503" />
>
><img src="photo/image-20230801140916391.png" alt="image-20230801140916391" />
>
>![image-20230801140925743](photo/image-20230801140925743.png)
>
>```
